---
name: ai-forge-recap
description: "Read a skill or agent's body and report what it actually does vs. what the description claims: drift, undeclared behaviors, verdict. After the recap, offers context-sensitive actions: fix frontmatter via ai-forge-apply, hand off to ai-forge-update, run ai-forge-judge, or run ai-forge-review (agents only). Use before updating a skill or agent. Triggers are recap [skill], what does [skill] do, audit [skill] description, summarize [skill]."
---
